package com.reehan2906.ScarnesDice;
...
public class MainActivity extends AppCompatActivity {
    ...
    public final int MAX_DICE_VALUE = 6;
...
*/
    public void updateTextView()
    {
        ...
        TextView textView1 = findViewById(R.id.tempScore);
    ...
    {
        TextView textActionView = findViewById(R.id.action);
        String actionText=a;
        if (userTurn) {
            actionText = "User " + a;
        } else {
    ...
    {
        TextView holdText = findViewById(R.id.holdText);
    ...
    public void computerTurn()
    {
        ...
        final TextView winTextView = findViewById(R.id.winText);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView winTextView = findViewById(R.id.winText);
